...
function getNextTile() {
  return guessGrid.querySelector(":not([data-state])")
}
...
function deleteKey() {
  ...
  if (lastActiveTile) {
    lastActiveTile.removeAttribute('data-letter')
    lastActiveTile.removeAttribute('data-state')
...
function submitGuess() {
  const activeTiles = [...getActiveTiles()]
  const guess = activeTiles.map(tile => tile.getAttribute('data-letter')).join((""))
...
function checkWinLose(guess, tiles) {
  if (targetWord === guess) {
    ...
    result.style.backgroundColor = '#538d4e'
  ...
  if (getNextTile() === null) {
    ...
    result.style.backgroundColor = '#d63d3d'
    result.style.opacity = 1
    stopInteraction()
    return
  }
